...
public class MemoryGame {
    ...
    public void drawFrame(String s) {
        ...
        if (!gameOver) {
            Font smallFont = new Font("Monaco", Font.BOLD, 18);
        ...
        //2. sets the font to be large and bold (size 30 is appropriate)
        Font largeFont = new Font("Monaco", Font.BOLD, 30);
        StdDraw.setFont(largeFont);
        //3. draws the input string so that it is centered on the canvas
        StdDraw.setPenColor(StdDraw.WHITE);
